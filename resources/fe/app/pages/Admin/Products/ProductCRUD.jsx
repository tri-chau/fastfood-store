                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody >
                                ...
                                {/* Hiển thị topping */}
                                {topping_data?.map((category, categoryIndex) => (
                                    category.topping_list?.map((item, toppingIndex) => (
                                        <tr
                                            key={`topping-${categoryIndex}-${toppingIndex}`}
                                            className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700"
                                        >
                                            <td className="p-4 w-4">
                                                <div className="flex items-center">
                                                    <input
                                                        id={`checkbox-table-topping-${categoryIndex}-${toppingIndex}`}
                                                        type="checkbox"
                                                        className="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                                    />
                                                    <label
                                                        htmlFor={`checkbox-table-topping-${categoryIndex}-${toppingIndex}`}
                                                        className="sr-only"
                                                    >
                                                        checkbox
                                                    </label>
                                            ...
                                            <td className="p-4">{item.product_name} (Topping)</td>
                                            <td className="p-4">{item.product_description}</td>
                                            <td className="p-4">{category.category_name}</td>
                                            <td className="p-4">{item.product_price}</td>
                                            <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <div className="flex items-center space-x-3 justify-end">
                                                    <button
                                                        type="button"
                                                        onClick={() => handleUpdateProductClick(item.product_id)}
                                                        className="py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-primary rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary dark:focus:ring-primary-800"
                                                    >
                                                        <svg

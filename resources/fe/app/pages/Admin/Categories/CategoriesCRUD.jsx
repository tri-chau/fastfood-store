...
const CategoryCRUD = () => {
  ...
  const handleDeleteCategory = async (id) => {
    ...
    // const categories = [
    //     {
    //         id: "41c1e191-3fa0-11f0-9dc5-c4efbb5e3d83",
    //         name: 'Candy',
    //         description: 'This is candy',
    //         type: 'Food',
    //         priority: 0,
    //         show_for_customer: 1,
    //         image_path: '',
    ...
    //     },
    //     {
    //         id: "ae6b6ad4-2ae6-11f0-96e3-c4efbb5e3d83",
    //         name: 'soup',
    //         description: 'soup',
    //         type: 'Food',
    //         priority: 0,
                                ...
                                <tr key={index}
                                    ...
                                    <td className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div className="flex items-center space-x-3 justify-end">
                                            <button type="button" onClick={() => handleEditCategoryClick(item)}
                                            ...
                                            <button type="button" onClick={() => handleDeleteCategoryClick(item.id)}
